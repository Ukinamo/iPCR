        ...
        <template #header>
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Add a new account using a dedicated create page.</p>
                </div>
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    <form class="grid gap-4 md:grid-cols-2" @submit.prevent="submit">
                        ...
                        <div>
                            ...
                            <input id="password" v-model="form.password" type="password" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required />
